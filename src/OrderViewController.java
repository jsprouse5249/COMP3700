...
public class OrderViewController {
    ...
    private JTextField orderCustomerIDTF;
    private JTextField orderTotalCostTF;
    private JButton loadOrderButton;
    private JButton saveOrderButton;
    private JTextField orderTotalTaxTF;
    ...
    public OrderViewController(Client client) {
        ...
        saveOrderButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                order.setCustomerID(Integer.parseInt(orderCustomerIDTF.getText()));
                order.setTotalCost(Double.parseDouble(orderTotalCostTF.getText()));
                order.setTotalTax(Double.parseDouble(orderTotalTaxTF.getText()));
    ...
    public void updateOrderInfo(Order order) {
        ...
        orderCustomerIDTF.setText(String.valueOf(order.getCustomerID()));
        orderTotalCostTF.setText(String.valueOf(order.getTotalCost()));
        orderTotalTaxTF.setText(String.valueOf(order.getTotalTax()));
    }
}
